  ...
  Twitter(String k, float period)
  {
    ...
    void setup()
    {
      ...
      cb.setDebugEnabled(false)
        .setOAuthConsumerKey("3N8IjoEGn8nBmQRpRmuIQ")
          .setOAuthConsumerSecret("17FsqgHeDnn2omUBOMwpfkgGmfvuKU51bfmPpnjyrk")
            .setOAuthAccessToken("8675642-riu3OzSYsLGexaFXLIIGBPv7QC8oKKKbbEEg69vmQ")
              .setOAuthAccessTokenSecret("yS2LlYoUB5kOzoVlwdMzSnTGcvXgba3yh0cZOI40c");  
